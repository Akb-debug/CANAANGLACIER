    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_reduction', models.CharField(choices=[('pourcentage', 'Pourcentage'), ('montant_fixe', 'Montant fixe')], default='pourcentage', max_length=20)),
                ('valeur', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, verbose_name='Valeur de la réduction')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adresse_livraison', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='CGAPP.adresselivraison')),
                ('coupon', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='CGAPP.coupon')),
                ('livreur', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='CGAPP.livreur')),
            ],
        ),
        migrations.CreateModel(
            name='AvisProduit',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statut', models.CharField(choices=[('en_attente', 'En attente'), ('payé', 'Payé'), ('échoué', 'Échoué'), ('annulé', 'Annulé')], default='en_attente', max_length=20)),
        ...
        migrations.AddField(
            ...
            name='produit',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='avis', to='CGAPP.produit'),
        ),
        migrations.CreateModel(
            name='Utilisateur',
            fields=[
                ...
                ('role', models.CharField(choices=[('client', 'Client'), ('admin', 'Admin'), ('serveur', 'Serveur'), ('gerant', 'Gérant'), ('livreur', 'Livreur')], max_length=10)),
        ...
        migrations.AddField(
            model_name='notationcommande',
            name='utilisateur',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='notations_commandes', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='livreur',
            name='utilisateur',
        ...
        migrations.AddField(
            model_name='avisproduit',
            name='utilisateur',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='avis_produits', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
