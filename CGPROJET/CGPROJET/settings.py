"""
Django settings for CGPROJET project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'CGAPP', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'CGPROJET.wsgi.application'
...
LANGUAGE_CODE = 'fr-fr'   # Définit le français comme langue par défaut

TIME_ZONE = 'Africa/Lome'  # Remplace UTC par ton fuseau horaire local (Togo)

USE_I18N = True  # Active la traduction internationale (i18n)
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'CGAPP/static'),
]
